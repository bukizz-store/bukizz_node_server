...
export class RetailerSchoolRepository {
  ...
  async findByRetailerAndSchool(retailerId, schoolId) {
    ...
    if (error) {
      logger.error(
        "RetailerSchoolRepository.findByRetailerAndSchool error:",
        error,
      );
      throw error;
    }
  ...
  /**
   * Get all pending retailer-school links globally (for admin)
   * @returns {Array}
   */
  async findAllPending() {
    ...
    if (error) {
      logger.error("RetailerSchoolRepository.findAllPending error:", error);
      throw error;
    }
  ...
  async updateStatus(retailerId, schoolId, currentStatus, newStatus) {
    ...
    if (deleteError) {
      logger.error(
        "RetailerSchoolRepository.updateStatus delete error:",
        deleteError,
      );
      throw deleteError;
    }
    ...
    if (insertError) {
      logger.error(
        "RetailerSchoolRepository.updateStatus insert error:",
        insertError,
      );
      throw insertError;
    }
  ...
  async deleteByCompositeKey(retailerId, schoolId, status) {
    ...
    if (error) {
      logger.error(
        "RetailerSchoolRepository.deleteByCompositeKey error:",
        error,
      );
      throw error;
    }
  ...
  async deleteAllByRetailerAndSchool(retailerId, schoolId) {
    ...
    if (error) {
      logger.error(
        "RetailerSchoolRepository.deleteAllByRetailerAndSchool error:",
        error,
      );
      throw error;
    }
