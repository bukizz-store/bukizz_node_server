...
export class RetailerController {
  ...
  createRetailerProfile = asyncHandler(async (req, res) => {
    ...
    const result = await retailerService.onboardRetailer(
      retailerId,
      data,
      signatureFile,
    );
   ...
   * PUT /api/v1/retailer/data
   */
  updateRetailerProfile = asyncHandler(async (req, res) => {
    ...
    const result = await retailerService.updateRetailerProfile(
      retailerId,
      data,
      signatureFile,
    );

    logger.info("Retailer profile updated", { retailerId });
